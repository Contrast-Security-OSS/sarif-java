...
public abstract class Invocation {
  ...
  public abstract static class Builder {
    ...
    public abstract Invocation.Builder setRuleConfigurationOverrides(
        List<ConfigurationOverride> ruleConfigurationOverrides);

    public abstract Invocation.Builder setNotificationConfigurationOverrides(
        List<ConfigurationOverride> notificationConfigurationOverrides);

    public abstract Invocation.Builder setToolExecutionNotifications(
        List<Notification> toolExecutionNotifications);

    public abstract Invocation.Builder setToolConfigurationNotifications(
        List<Notification> toolConfigurationNotifications);
    ...
    public abstract Invocation.Builder setProcessStartFailureMessage(
    ...
    public abstract Invocation.Builder setEnvironmentVariables(
