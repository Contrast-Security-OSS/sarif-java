...
public abstract class ConfigurationOverride {
    ...
    public abstract static class Builder {
        public abstract ConfigurationOverride.Builder setConfiguration(ReportingConfiguration configuration);
        public abstract ConfigurationOverride.Builder setDescriptor(ReportingDescriptorReference descriptor);
