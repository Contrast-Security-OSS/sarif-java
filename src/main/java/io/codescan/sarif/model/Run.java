...
public abstract class Run {
    ...
    public abstract static class Builder {
        ...
        //public abstract Run.Builder setVersionControlsProvenance(List<VersionControlDetails> versionControlsProvenance);
        public abstract Run.Builder setOriginalUriBaseIds(Map<String, ArtifactLocation> originalUriBaseIds);
        ...
        //public abstract Run.Builder setExternalPropertyFileReference(ExternalPropertyFileReference externalPropertyFileReference);
        public abstract Run.Builder setThreadFlowLocations(List<ThreadFlowLocation> threadFlowLocations);
