...
public abstract class ReportingDescriptor {
  ...
  public abstract static class Builder {
    ...
    public abstract ReportingDescriptor.Builder setShortDescription(
        MultiformatMessageString shortDescription);

    public abstract ReportingDescriptor.Builder setFullDescription(
        MultiformatMessageString fullDescription);

    public abstract ReportingDescriptor.Builder setMessageStrings(
        Map<String, MultiformatMessageString> messageStrings);

    public abstract ReportingDescriptor.Builder setDefaultConfiguration(
    ...
    public abstract ReportingDescriptor.Builder setRelationships(
        List<ReportingDescriptorRelationship> relationships);
