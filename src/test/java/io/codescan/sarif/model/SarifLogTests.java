...
public class SarifLogTests {
    ...
    public void GivenNoData_WhenSerialized_ThenSchemaAndVersionPresent() throws IOException {
        var tool = Tool.builder().setDriver(
                ToolComponent.builder().setName("testdriver").build()
        ).build();
        ...
        JsonNode expected = mapper.readTree(new StringBuilder()
                .append("{\"$schema\": \"https://raw.githubusercontent.com/oasis-tcs/sarif-spec/master/Schemata/sarif-schema-2.1.0.json\",")
